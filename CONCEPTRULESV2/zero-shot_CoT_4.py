...
def ZeroShotCoT_call1(demo, context, question, model="gpt"):
...
with open("V2-zeroshot-cot-4.csv", "w", newline="", encoding="utf-8") as csv_file:
    ...
    for entry in selected_entries:
        ...
        for question in entry["questions"]:
            ...
            print("Writing to CSV:", question["id"], response_part_2, label)

            csv_writer.writerow([question["id"], response_part_2, label])
